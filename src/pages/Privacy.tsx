...
const Privacy = () => (
  <Layout title="Privacy Policy" description="RetroRoots's privacy policy — how we collect, use, and protect your personal data.">
    ...
    <section className="section-padding">
      <div className="container mx-auto max-w-3xl prose prose-sm">
        {[
          ...
          {t:"Your Rights",c:"You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at retroroots@yahoo.com. We comply with applicable Indian IT Act provisions and GDPR requirements for EU visitors."},
          {t:"Contact",c:"For privacy-related queries, contact us at: RetroRoots, Plot No. 123, Industrial Area, Rajkot, Gujarat 360002, India. Email: retroroots@yahoo.com"},
        ].map(s=>(
