  ...
  <section className="section-padding bg-muted">
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
        {posts.map(p => (
          <a key={p.id} href="https://www.instagram.com/retro_roots.in/" target="_blank" rel="noopener noreferrer" className="group relative aspect-square rounded-lg overflow-hidden">
            ...
            <div className="absolute inset-0 bg-foreground/50 opacity-0 group-:opacity-100 transition-opacity flex items-center justify-center">
