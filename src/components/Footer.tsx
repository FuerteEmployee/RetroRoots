    ...
    <div className="container mx-auto section-padding pb-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="lg:col-span-2">
          <h3 className="text-2xl font-bold mb-4">FLEXICORE</h3>
          <p className="text-primary-foreground/70 text-sm leading-relaxed mb-4">
            Premium solid surface & tiles manufacturer based in Rajkot, Gujarat. Seamless surfaces, timeless elegance — crafted with precision, exported to 25+ countries worldwide.
          </p>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm text-primary-foreground/60">
            <div className="flex gap-2 items-start">
              ...
              <span>Plot No. 123, Industrial Area, Rajkot, Gujarat 360002, India</span>
            </div>
      ...
      <div className="border-t border-primary-foreground/10 mt-10 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
        <p className="text-xs text-primary-foreground/40">© 2026 Flexicore. All rights reserved. Made with ❤️ in Rajkot, India.</p>
