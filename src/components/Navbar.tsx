...
//                     </div>
//                   </div>
//                   <span className={`font-bold transition-all duration-300 ${scrolled ? "text-[11px] text-black uppercase tracking-widest" : "text-[11px] uppercase text-black tracking-tighter"} ${new URLSearchParams(location.search).get('on_sale') === 'true' ? 'text-primary' : 'group-:text-black/70'}`}>
//                     Sale
//                   </span>
//                 </Link>
//               </div>
            ...
            <div className="p-8 pt-12 md:p-12">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xs text-gray-500 font-normal leading-relaxed">
                  ...
                  <span className="text-primary font-semibold cursor-pointer hover:underline">Terms and Conditions</span>
                </p>
        ...
        <div className={`hidden lg:block border-t border-border bg-white transition-all duration-300 ${scrolled ? "py-1.5" : "py-3"}`}>
          <div className="container mx-auto px-4 lg:px-8">
            <div className="flex items-center justify-center gap-2 xl:gap-8 transition-all duration-300">
              ...
              {/* SALE ITEM — always black, no active color change */}
              {/* <div className="relative group">
                <Link to="/products?on_sale=true" className={`flex flex-col items-center ${scrolled ? "gap-0 px-2" : "gap-1.5"}`}>
                  <div className={`rounded-full overflow-hidden transition-all duration-500 ease-in-out border-2 border-black flex items-center justify-center bg-black text-white text-center p-1 ${scrolled
                      ? "w-0 h-0 opacity-0 mb-0 scale-0 border-0"
                      : "w-16 h-16 xl:w-[72px] xl:h-[72px] mb-1.5 opacity-100 scale-100 shadow-lg shadow-black/20"
                    }`}>
                    <div className="flex flex-col items-center">
                      <span className="text-[7px] uppercase font-bold leading-tight">Clearance</span>
                      <span className="text-[14px] font-black leading-none italic uppercase">Sale</span>
              ...
              {/* ✅ FIX: Always black — removed text-primary active condition */}
              {/* <span className={`font-bold transition-all duration-300 text-black uppercase ${scrolled ? "text-[11px] tracking-widest" : "text-[11px] tracking-tighter"
                    }`}>
                    Sale
                  </span>
                </Link>
